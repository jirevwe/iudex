...
export interface StdLib {
  encode: typeof encoding.encode;
  decode: typeof encoding.decode;
  crypto: {
    md5: typeof crypto.md5;
    sha1: typeof crypto.sha1;
    sha256: typeof crypto.sha256;
    sha512: typeof crypto.sha512;
    hmacSHA1: typeof crypto.hmacSHA1;
    hmacSHA256: typeof crypto.hmacSHA256;
    hmacSHA512: typeof crypto.hmacSHA512;
  ...
  string: {
    ...
    kebabCase: typeof string.kebabCase;
    constantCase: typeof string.constantCase;
    capitalize: typeof string.capitalize;
    titleCase: typeof string.titleCase;
    lowerCase: typeof string.lowerCase;
    upperCase: typeof string.upperCase;
    truncate: typeof string.truncate;
    padLeft: typeof string.padLeft;
    padRight: typeof string.padRight;
    reverse: typeof string.reverse;
    repeat: typeof string.repeat;
    trim: typeof string.trim;
    trimLeft: typeof string.trimLeft;
    trimRight: typeof string.trimRight;
    replaceAll: typeof string.replaceAll;
    contains: typeof string.contains;
 ...
 *
 * @returns Standard library object
 *
 * @example
 ...
 * });
 */
export function createStdObject(): StdLib {
  return {
    // Encoding/Decoding
...
// Re-export types
export type { DateInput, TimeUnit, Inclusivity } from './datetime.js';
export type { AnyObject, Predicate, Iteratee, ObjectModule, ArrayModule } from './object.js';
export type { SchemaValidationResult } from './validators.js';
export type { EncodeModule, DecodeModule } from './encoding.js';
